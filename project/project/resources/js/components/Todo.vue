        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
                <div class="card d-flex">
                    ...
                    <div class="card-body">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button v-if="!edit_todo_id" type="button"
                    ...
                    <button @click="resetTodo()" type="button" class="btn btn-sm float-right text-danger">Reset</button>
                    ...
                    <table class="table table-bordered mt-4">
                        ...
                        <tbody>
                            <tr v-for="(todo, index) in todos" :key="index">
                                ...
                                <td>{{ todo.name }}</td>
                                <td>
                                    <button @click="deleteTodo(--index)" type="button" class="btn btn-sm btn-danger">
                                        Delete
                                    </button>
                                    <button @click="editTodo(--index)" type="button" class="btn btn-sm btn-primary text-white ml-4">
                                        Edit
                                    </button>
                                </td>
                            </tr>
